"""
Django settings for restless_cell_40943 project.
...
ROOT_URLCONF = 'restless_cell_40943.urls'
...
WSGI_APPLICATION = 'restless_cell_40943.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_cell_40943 API",
    "DESCRIPTION": "API documentation for restless_cell_40943 App",
    "VERSION": "v1",
}
